...
*/
var aa=__webpack_require__(0),n=__webpack_require__(1),r=__webpack_require__(6);function t(a){for(var b=a.message,c="https://reactjs.org/docs/error-decoder.html?invariant="+b,d=1;d<arguments.length;d++)c+="&args[]="+encodeURIComponent(arguments[d]);a.message="Minified React error #"+b+"; visit "+c+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings. ";return a}if(!aa)throw t(Error(227));var ba=null,ca={};
...
// EXTERNAL MODULE: ./src/base.css
var base = __webpack_require__(8);

// EXTERNAL MODULE: ./src/images/loading.gif
var images_loading = __webpack_require__(3);
var loading_default = /*#__PURE__*/__webpack_require__.n(images_loading);
...
function (_React$PureComponent) {
  ...
  _createClass(Loading, [{
    ...
    value: function render() {
      ...
      }, "\u52A0\u8F7D\u4E2D..."), react_default.a.createElement("span", {
        style: {
...
// CONCATENATED MODULE: ./src/MainView.js
function MainView_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { MainView_typeof = function _typeof(obj) { return typeof obj; }; } else { MainView_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return MainView_typeof(obj); }

function MainView_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function MainView_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function MainView_createClass(Constructor, protoProps, staticProps) { if (protoProps) MainView_defineProperties(Constructor.prototype, protoProps); if (staticProps) MainView_defineProperties(Constructor, staticProps); return Constructor; }

function MainView_possibleConstructorReturn(self, call) { if (call && (MainView_typeof(call) === "object" || typeof call === "function")) { return call; } return MainView_assertThisInitialized(self); }

function MainView_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function MainView_getPrototypeOf(o) { MainView_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return MainView_getPrototypeOf(o); }

function MainView_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) MainView_setPrototypeOf(subClass, superClass); }

function MainView_setPrototypeOf(o, p) { MainView_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return MainView_setPrototypeOf(o, p); }
...
/*#__PURE__*/
function (_React$PureComponent) {
  MainView_inherits(MainView, _React$PureComponent);

  function MainView() {
    MainView_classCallCheck(this, MainView);

    return MainView_possibleConstructorReturn(this, MainView_getPrototypeOf(MainView).apply(this, arguments));
  }

  MainView_createClass(MainView, [{
    key: "render",
    value: function render() {
      return react_default.a.createElement(react["Fragment"], null, react_default.a.createElement("div", {
      ...
      }, "\u6211\u7684\u6392\u540D: 2\u540D"), react_default.a.createElement("span", {
        id: "myFuel",
        className: "rightView rankingText"
      }, "\u6211\u7684\u6CB9\u8017: 6L/100KM")), react_default.a.createElement("div", {
        id: "rankingData",
        className: "rankingText"
      }, "2019\u5E7410\u67084\u65E5\u6392\u884C\u699C\uFF1A"), react_default.a.createElement("div", {
        id: "fuelRanking",
        ...
        return react_default.a.createElement("div", {
          ...
          className: "leftView"
        }, "".concat(index + 1, " ").concat(item.vin)), react_default.a.createElement("span", null, "".concat(item.fuelCapacity, " ").concat(item.fuelUnit)));
      }))));
    }
  }]);
...
// CONCATENATED MODULE: ./lib/h5NativeBridage/h5NativeBridge.js
var Bridge = {
...
/* harmony default export */ var h5NativeBridge = (Bridge);
...
function (_React$Component) {
  ...
  function App(props) {
    ...
    _this = src_possibleConstructorReturn(this, src_getPrototypeOf(App).call(this, props));
    _this.state = {
      loading: true
    };
    return _this;
  ...
  src_createClass(App, [{
    ...
    value: function render() {
      ...
      return react_default.a.createElement("div", {
        className: "mainView"
      }, loading && react_default.a.createElement(components_Loading, null), !loading && react_default.a.createElement(MainView_MainView, null));
    }
  }]);
